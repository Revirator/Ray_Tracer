...
//Custom method to draw triangle in the color red
//Used for visual debuggers in traversal
...
{        
    ...
    glNormal3fv(glm::value_ptr(v0.normal));
    glVertex3fv(glm::value_ptr(v0.position+scale));
    glNormal3fv(glm::value_ptr(v1.normal));
    glVertex3fv(glm::value_ptr(v1.position+scale));
    glNormal3fv(glm::value_ptr(v2.normal));
    glVertex3fv(glm::value_ptr(v2.position+scale));
    glEnd();
    scale = -scale;
    glBegin(GL_TRIANGLES);
    glPushAttrib(GL_ALL_ATTRIB_BITS);
